...
public class BioUdpClient extends AbstractBioUdpBase{
	...
	public static void main(String[] args) throws IOException {
		...
		String data = "udpClient1";
		//由于UDP/IP是无连接的，如果希望双向通信，就必须启动一个监听端口，承担服务器的职责，如果不能
		//绑定到指定端口，则抛出SocketException
		InetSocketAddress socketAddress = new InetSocketAddress(SERVER_IP, SERVER_2_PORT);
		DatagramSocket serverSocket = new DatagramSocket(SERVER_1_PORT);
		...
		System.out.println("收到信息：" + new String(buffer,Charset.forName("UTF-8")));
	}
